# [1.1.0](https://github.com/johnlindquist/simple/compare/v1.0.2...v1.1.0) (2021-02-02)
...
* **app:** quit ([f6fda2d](https://github.com/johnlindquist/simple/commit/f6fda2db990d4ab0e7c9b0273d78f2a920e021fe))
* **build:** add publish to beta branch ([bab3bc2](https://github.com/johnlindquist/simple/commit/bab3bc2fcd530a9df7b1cb3138af142ce175e083))
* **css:** Adding base styles for show windows ([01abacc](https://github.com/johnlindquist/simple/commit/01abacc39eee4dc3c268857c8bd8a816b65a4d4b))
* **css:** dark mode ([1f50dd3](https://github.com/johnlindquist/simple/commit/1f50dd3bc382abed4d08b52e93bdc39917d70b02))
* **css:** styling list elements ([60cca46](https://github.com/johnlindquist/simple/commit/60cca46439fa3f72d41b9058f9c4d2398a71c21a))
* **prompt:** Always focus, no matter what :D ([78292eb](https://github.com/johnlindquist/simple/commit/78292ebbc22015ee86191e148ac19a0341ac942b))
* **prompt:** clear on escape. Show info ([8bfa6ba](https://github.com/johnlindquist/simple/commit/8bfa6bab436e0465dad2160cf063356b66bd6b5e))
* **prompt:** Fix positioning when displays side-by-side ([662914c](https://github.com/johnlindquist/simple/commit/662914c15dc4b2c268e915a5f857ce4cdf3fb5aa))
* **prompt:** Fix top-right positioning logic ([b0593c8](https://github.com/johnlindquist/simple/commit/b0593c810b9c6fa5768de7b7ee15d00d2d182c21))
* **prompt:** fixing ratio sizing ([0369d69](https://github.com/johnlindquist/simple/commit/0369d69df497903b4b7a1a22cd04d82910cb7a01))
* **prompt:** Fixing size of prompt ([dbbceb1](https://github.com/johnlindquist/simple/commit/dbbceb1243d0a01d1ce0945524c55524bceca802))
* **prompt:** Guard against closed windows when quitting ([c95f38e](https://github.com/johnlindquist/simple/commit/c95f38e0adbd6b52a8b830b4df07eabf78cfc1c2))
* **prompt:** Hide the prompt unless interrupted by a message ([5712ba1](https://github.com/johnlindquist/simple/commit/5712ba1a3a0b3f1679eb0ea15a2ded840fe570cd))
* **prompt:** removing shadow ([9c091ee](https://github.com/johnlindquist/simple/commit/9c091ee7d8d33b8ca3c40dfe79353f7f79e44a88))
* **scripts:** Pass SIMPLE_CONTEXT as 'app' ([b545bad](https://github.com/johnlindquist/simple/commit/b545bad2d0d6ed58438cdfa48d52f6421e382965))
...
* **simple:** Remove process timeout that closed prompt ([4d1392b](https://github.com/johnlindquist/simple/commit/4d1392b4e0e3ffc9eb79b220bc2a8b37f5c26723))
* **updater:** debug updater ([ea758a9](https://github.com/johnlindquist/simple/commit/ea758a9d8788c906b8627089fd606685e24859d9))
* **yarn:** updaet yarn.lock ([75e3946](https://github.com/johnlindquist/simple/commit/75e39469baab7e9ba0ac75660c5183008a7bd50e))
* Add PATH to detect vs code and switch to mac ([f4c55e2](https://github.com/johnlindquist/simple/commit/f4c55e29c874f36c55598980955014dad34ccf95))
...
* **css:** Dark mode first pass ([8352208](https://github.com/johnlindquist/simple/commit/83522080f3fb06f7a869a2fa4dc5d3ef04f00749))
* **debug:** Add debug window when alt+click ([6b870b7](https://github.com/johnlindquist/simple/commit/6b870b7cdcec02e1a43b5fa4a0b501c0c03bff74))
* **debug:** Debug from anywhere ([5ca6050](https://github.com/johnlindquist/simple/commit/5ca6050aa67343ea46706cc3c1b8cbef27ca23d6))
* **notifications:** testing loading styles from a protocol ([0783a9a](https://github.com/johnlindquist/simple/commit/0783a9a61b1625e06f90df170491a6a3367e13d4))
...
* **prompt:** Proper scrolling! 🚀 ([1d6adf4](https://github.com/johnlindquist/simple/commit/1d6adf4aa20cbcc766a9a87994fd98c341813872))
* **show:** Add show command to display arbitrary html ([5e602ff](https://github.com/johnlindquist/simple/commit/5e602ff0eb4707dea76fb1e56eb3ee62f91ece6c))
* **url:** Open links in external browser, not electron ([8fd6fa1](https://github.com/johnlindquist/simple/commit/8fd6fa18ba2faaab9930213fb54a7077041f0e46))
