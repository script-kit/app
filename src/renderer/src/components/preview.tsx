...
import { cmdAtom, darkAtom, hasPreviewAtom, inputFocusAtom, mouseEnabledAtom, previewHTMLAtom, uiAtom } from '../jotai';
...
function Preview() {
  ...
  useEffect(() => {
    ...
    const elements = Array.from(document.querySelectorAll('.hljs')) as HTMLElement[];
  ...
  return (
    ...
    >
      ...
      {previewHTML && <div className="preview h-full w-full" dangerouslySetInnerHTML={{ __html: previewHTML }} />}
    </div>
  );
}
