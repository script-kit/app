...
import React, { type FC, type Key, useCallback, useEffect, useRef, useState } from 'react';
...
const ChatList: FC<IMessageListProps> = ({
  ...
  const onScroll = (_e: React.UIEvent<HTMLElement>): void => {
  ...
  const onMouseDown = (_e: React.MouseEvent<HTMLDivElement>) => {};
...
export function Chat() {
  ...
  const onSubmit = useCallback(
    ...
    [currentMessage, messages, setCurrentMessage, submitMessage, isComposing],
  );
