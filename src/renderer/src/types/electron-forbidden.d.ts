...
export const ELECTRON_IMPORT_ERROR: never =
  'ERROR: Direct electron imports are forbidden in renderer process! Use window.electron or import from @/utils/electron-renderer instead.' as never;
