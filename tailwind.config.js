...
const safeListStartsWith = [
  ...
  'h', 'min-h', 'max-h',
  'w', 'min-w', 'max-w',
  'rounded', 'rounded-t', 'rounded-b', 'rounded-l', 'rounded-r', 'rounded-full',
  ...
  'justify', 'justify-items', 'justify-content', 'justify-self',
  'order',
