...
const defaultBarrels = ['src/renderer/src/state/atoms/index.ts', 'src/renderer/src/state/index.ts'];
const barrelPaths = (barrelArg ? barrelArg.split(',') : defaultBarrels).map((p) => path.resolve(p));
...
const barrelFiles = new Set(barrelSourceFiles.map((sf) => sf.getFilePath()));
